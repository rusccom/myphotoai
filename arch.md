...
#### `PhotoGallery` (137 строк JSX + 300 строк CSS)
- Отображение галереи изображений
- Интеграция с `ImageCard`
- Кнопка "Load More" для пагинации
- Обработка действий (Download, Share, Try On, Upscale, Video, Edit Photo)
- **Share**: текст title/text временно закомментирован (2025-12-01), отправляется только файл
...
- **Меню действий** (обновлено 2025-12-02):
  - 6 кнопок в двухрядной раскладке (grid 4 колонки)
  - Верхний ряд: Try On, Video, Upscale, Edit Photo
  - Нижний ряд: Share, Download (каждая на 2 колонки)
  - CSS grid с `grid-column: span 2` для нижнего ряда
...
#### `EditPhotoTab` (~200 строк, обновлено 2025-12-02)
...
- **Поддержка изображения из галереи** (обновлено 2025-12-02):
  - Props: `imageFromGallery`, `onClearGalleryImage`
